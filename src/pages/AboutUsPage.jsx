...
const AboutUsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#fff8ea_0%,#fefbf3_48%,#fffdf8_100%)] pb-5 pt-[4.75rem] dark:bg-[radial-gradient(26rem_circle_at_78%_-6%,rgb(245_158_11/0.15),transparent_38%),linear-gradient(180deg,rgb(15_11_5/0.98)_0%,rgb(24_16_7/0.96)_54%,rgb(10_7_3/0.98)_100%)]">
      ...
      <main className="px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        ...
        >
          <div className="relative w-full overflow-hidden rounded-[18px] border border-amber-200/80 bg-white p-4 shadow-[0_28px_80px_-56px_rgba(15,23,42,0.55)] ring-1 ring-white/80 sm:p-6 lg:p-8 dark:border-amber-400/20 dark:bg-[linear-gradient(180deg,rgb(15_11_5/0.98),rgb(24_16_7/0.96))] dark:shadow-[0_28px_90px_-62px_rgba(245_158_11,0.25)] dark:ring-white/5">
            <div className="absolute inset-x-0 top-0 h-1 bg-[linear-gradient(90deg,#d97706,#f59e0b,#fbbf24)] dark:bg-[linear-gradient(90deg,#d97706,#f59e0b,#fbbf24)]" />

            <div className="grid items-stretch gap-5 lg:grid-cols-[0.82fr_1.18fr]">
              <div className="relative flex flex-col items-center justify-center overflow-hidden rounded-[14px] border border-amber-200 bg-[linear-gradient(160deg,#fffdf7_0%,#fff7df_56%,#ffffff_100%)] px-5 py-8 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.9)] sm:py-10 dark:border-amber-400/18 dark:bg-[linear-gradient(160deg,rgba(245,158,11,0.1)_0%,rgba(217,119,6,0.06)_54%,rgb(15_11_5/0.9)_100%)] dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
                <div className="absolute -left-14 -top-14 h-32 w-32 rounded-full bg-amber-200/50 blur-2xl dark:bg-amber-400/10" />
                ...
                <div className="relative flex flex-col items-center gap-3">
                  <div className="relative flex h-20 w-20 items-center justify-center rounded-[18px] border border-amber-300/80 bg-white/88 p-2 shadow-[0_18px_38px_-24px_rgba(245,158,11,0.95),0_0_0_6px_rgba(245,158,11,0.08)] dark:border-amber-400/30 dark:bg-amber-950/20 dark:shadow-[0_18px_40px_-24px_rgba(245,158,11,0.8),0_0_0_6px_rgba(245,158,11,0.08)]">
                    <span className="absolute inset-0 rounded-[18px] bg-[linear-gradient(135deg,rgba(245,158,11,0.18),rgba(217,119,6,0.12),rgba(251,191,36,0.13))]" />
                    <img
                      src={brandIconImage}
                      alt="KANZ COINS"
                      loading="eager"
                      decoding="async"
                      className="relative h-full w-full object-contain drop-shadow-[0_10px_18px_rgba(15,23,42,0.18)] dark:drop-shadow-[0_10px_18px_rgba(245,158,11,0.2)]"
                    />
                  </div>
                  <div dir="ltr" className="text-center">
                    <p className="text-[1.15rem] font-black uppercase leading-none tracking-[0.12em] sm:text-[1.35rem]">
                      <span className="bg-[linear-gradient(120deg,#0f172a_0%,#b45309_34%,#d97706_70%,#f59e0b_100%)] bg-clip-text text-transparent dark:bg-[linear-gradient(120deg,#fff7d6_0%,#fbbf24_30%,#f59e0b_66%,#d97706_100%)]">
                        KANZ
                      </span>
                      <span className="mx-1 text-amber-600 dark:text-amber-400">/</span>
                      <span className="bg-[linear-gradient(120deg,#7c2d12_0%,#d97706_38%,#b45309_100%)] bg-clip-text text-transparent dark:bg-[linear-gradient(120deg,#fef3c7_0%,#fde68a_48%,#f59e0b_100%)]">
                        COINS
                      </span>
                    </p>
                  </div>
